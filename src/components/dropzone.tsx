...
export function Dropzone(props) {
  ...
  const baseStyle =
    "flex flex-col items-center w-full p-5 border-2 border-dashed rounded bg-secondary text-muted-foreground outline-none transition ease-in-out duration-150";
